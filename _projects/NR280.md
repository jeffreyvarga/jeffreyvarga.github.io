...
I was featured as a presenter at the 2023 annual meeting of the Oregon Chapter of the American Fisheries Society.
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/NR280/DEM.png" title="DEM" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/NR280/Overview1.jpg" title="Overview1" class="img-fluid rounded z-depth-1" %}
    </div>
</div>

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/NR280/Overview2.png" title="Overview2" class="img-fluid rounded z-depth-1" %}
    </div>
</div>